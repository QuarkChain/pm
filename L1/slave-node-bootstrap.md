...
- **pyquarkchain** ([QuarkChain/pyquarkchain](https://github.com/QuarkChain/pyquarkchain)) is the *compatibility source of
...
- **goquarkchain** ([QuarkChain/goquarkchain](https://github.com/QuarkChain/goquarkchain)) is the *shape reference* for the Go
